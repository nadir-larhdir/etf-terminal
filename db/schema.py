...
INDEX_DEFINITIONS = {
    ...
    "idx_etf_universe_active_ticker": "CREATE INDEX IF NOT EXISTS idx_etf_universe_active_ticker ON etf_universe (active, ticker)",
}
...
def create_tables(engine) -> None:
    ...
    with engine.begin() as conn:
        _ensure_schema(conn)
        _rename_existing_table(conn, "securities", "etf_universe")
        _rename_existing_table(conn, "security_metadata", "etf_metadata")
        ...
        ensure_etf_metadata_schema(conn)
