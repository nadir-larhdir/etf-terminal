...
class FixedIncomeAnalyticsService:
        ...
        if (
            ...
            if benchmark_duration is not None and not benchmark_series.empty:
                ...
                if selection.spread_proxy_series_id:
                    ...
                    headline_60d, headline_120d = self._fallback_benchmark_models(
                        headline_60d,
                        headline_120d,
                        benchmark_frame,
                        benchmark_duration,
    ...
    def _spread_estimate_from_models(
        self,
        primary: dict | None,
        secondary: dict | None,
        latest_price: float,
        ...
        blended_spread = self._blended_metrics(primary, secondary, credit_key="credit_beta")
    ...
    def _fallback_benchmark_models(
        self,
        headline_60d: dict,
        headline_120d: dict,
